<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true"
    Inherits="Admin.Posts.AddEntry" ValidateRequest="False" EnableSessionState="True"
    CodeBehind="Add_entry.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphAdmin" runat="Server">
    <link href="../GettyImages/css/popup.css" rel="stylesheet" />
    <script src="../GettyImages/js/popup.js"></script>
    <div class="content-box-outer">
        <con:FileManager runat="server" ID="FileManager1" />
        <div class="content-box-full">
            <div class="rightligned-top action_buttons">
                <input type="button" id="btnSave2" value="<%=Resources.labels.savePost %>" class="btn primary rounded"
            ...
            <h1>
                <%=Resources.labels.addEditPost %></h1>
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    $('#gettyImage').click(function (e) {
                        $(".popupGettyImage").css("display", "block");
                    });
                    ...
                    $("#gettyImage").colorbox({ width: "800px", height: "1150px", inline: true, href: "#gettyImagePanel" });
                });
            ...
            <div runat="server" style="visibility: hidden; height: 1px">
                <div id="uploadVideoPanel" class="overlaypanel">
                    <h2>
                        <%=Resources.labels.insertVideo %></h2>
                    <ul class="fl" style="margin: 0;">
                        <li>
                            <asp:Label ID="lblVideoUpload" CssClass="lbl" AssociatedControlID="txtUploadVideo"
                                runat="server" Text='<%$ Resources:labels, uploadVideo %>' />
                            ...
                            <asp:RequiredFieldValidator ID="txtUploadVideoValidator" runat="Server" ControlToValidate="txtUploadVideo"
                                ErrorMessage="<%$ Resources:labels, required %>" ValidationGroup="videoupload" />
                        </li>
                        <li style="margin: 0;">
                            ...
                            <a href="#" onclick="return closeOverlay();">
                                <%=Resources.labels.cancel %></a> </li>
                    </ul>
                </div>
                <div id="uploadImagePanel" class="overlaypanel">
                    <h2>
                        <%=Resources.labels.insertImage %></h2>
                    <ul class="fl" style="margin: 0;">
                        <li>
                            <asp:Label ID="lblFileUpload" CssClass="lbl" AssociatedControlID="txtUploadImage"
                                runat="server" Text='<%$ Resources:labels, uploadImage %>' />
                            <asp:FileUpload runat="server" ID="txtUploadImage" CssClass="ImageUpload" Width="400"
                                size="50" ValidationGroup="imageupload" />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="Server" ControlToValidate="txtUploadImage"
                                ErrorMessage="<%$ Resources:labels, required %>" ValidationGroup="imageupload" />
                        </li>
                        <li style="margin: 0;">
                ...
                <div id="gettyImagePanel" class="overlaypanel">
                    <div class="popupGettyImage" style="display: none;">
                        <div class="companysetupimagebox">
                            <h2>
                                Post Getty Images</h2>
                            <div class="clear10">
                            </div>
                            <div class="wrapperGallery">
                                <div class="wrapperimageupload">
                                    <a class="btnuploadimage" onclick="InsertToPost();">
                                        <img title="Image Upload" src="../GettyImages/images/btn_insertToPost.png">
                                    </a>
                                    <div class="clear">
                                    </div>
                                </div>
                                ...
                                <div class="carousel-gallery">
                                    <div class="carousel groupr" id="my_carousel" style="width: 384px; height: 80px;
                            ...
                            <div class="companysetupimagebox1">
                                ...
                                <div class="wrapperGallery">
                                    <div class="searchbar">
                                        ...
                                        <input type="text" onfocus="if (this.value=='search gettyimages for more...') {this.value = '';}"
                                            onblur="if (this.value==''){this.value='search gettyimages for more...';}" value="search gettyimages for more..."
                                            id="search" name="btnSearch">
                                        <input type="image" id="btnSearch" onclick="LoadGettyImages();" name="search" src="../GettyImages/images/btn_search.png">
                                    ...
                                    <div id="carousel_viewimage1">
                                        <span></span>
                                        <img src="../GettyImages/images/preview-image.png">
                                        <div class="caption">
                                            <%--<a href="" class="btnuploadimage1"></a>--%>
                                            <input type="image" id="btnuploadimage1" class="btnuploadimage1" onclick="LoadGettyImages();">
                                        </div>
                                    </div>
                                    <div class="clear10">
                                    </div>
                                    <div class="carousel-wrapper-thumbs">
                                        <div class="carousel-gallery">
                                            <div class="carousel groupr" id="my_carousel1" style="width: 384px; height: 80px;
                                                visibility: visible; overflow: hidden; position: relative;">
                    ...
                    <ul class="fl" style="margin: 0;">
                        <li>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtUploadFile"
                                ErrorMessage="<%$ Resources:labels, required %>" ValidationGroup="fileUpload" />
                        </li>
                        <li style="margin: 0;">
                ...
                <tr>
                    <td style="vertical-align: top;" class="mainForm">
                        <ul class="fl">
                            ...
                            <li>
                                <div class="editToolbar">
                                    <asp:CheckBox runat="server" ID="cbUseRaw" Text="<%$Resources:labels,useRawHtmlEditor %>"
                                        AutoPostBack="true" />
                                    <a href="#" id="gettyImage" class="image">
                                        <%=Resources.labels.gettyImages %></a> <a href="#" id="uploadImage" class="image">
                                            <%=Resources.labels.insertImage %></a> <a href="#" id="uploadVideo" class="video">
                                                <%=Resources.labels.insertVideo %></a> <a href="#" id="uploadFile" class="file">
                                                    <%=Resources.labels.attachFile %></a> <a href="javascript:;" id="fileManager" class="file">
                                                        <%=Resources.labels.fileManager %></a>
                                </div>
                            ...
                            <li>
                                <asp:Label ID="Label2" CssClass="lbl" AssociatedControlID="txtSlug" runat="server"
                                    Text='<%$Resources:labels,slug %>' />
                                <asp:TextBox runat="server" ID="txtSlug" Width="600" />
                                <a href="javascript:void(GetSlug());">
                                    <%=Resources.labels.extractFromTitle %></a> </li>
                            <li>
                                <asp:Label ID="Label3" CssClass="lbl" AssociatedControlID="txtDescription" runat="server"
                                    Text='<%$Resources:labels, excerpt %>' />
                                <asp:TextBox runat="server" ID="txtDescription" TextMode="multiLine" Columns="50"
                                    Rows="3" Width="600" Height="80" />
                            </li>
                            <li>
                                <label class="lbl">
                                    <%=Resources.labels.options %></label>
                        ...
                        <ul class="fl">
                            ...
                            <li>
                                ...
                                <input type="radio" name="PublishDate" id="rbtAuto" onclick="toggleAutomaticDate()"
                                    checked="checked" /><label for="rbtAuto"><%=Resources.labels.automatically %></label>
                                <input type="radio" name="PublishDate" id="rbtManual" onclick="toggleAutomaticDate()" /><label
                                    for="rbtManual"><%=Resources.labels.manually %></label>
                                <div id="datePanel" style="display: none;">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtDate"
                                        ValidationExpression="[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]" ErrorMessage="<%$Resources:labels,enterValidDate %>"
                                        Display="dynamic" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDate"
                                        ErrorMessage="<%$Resources:labels,enterDate %>" Display="Dynamic" />
                                </div>
                            </li>
                            <li>
                                <label class="lbl">
                                    <%=Resources.labels.categories %></label>
                                ...
                                <div style="">
                                    <label for="<%=txtCategory.ClientID %>" style="margin-bottom: 5px; display: block;">
                                        <%=Resources.labels.quickAddNewCategory %></label>
                                    ...
                                    <asp:Button runat="server" ID="btnCategory" Text="<%$ Resources:labels, add %>" ValidationGroup="category"
                                        CssClass="btn" Style="min-width: 0px; margin: 0;" />
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtCategory"
                                        ErrorMessage="<%$ Resources:labels, required %>" ValidationGroup="category" Display="Dynamic" />
                                </div>
                            </li>
                            <li style="position: relative;">
                                <label class="lbl">
                                    <%=Resources.labels.tags%></label>
                                <asp:TextBox runat="server" ID="txtTags" TextMode="MultiLine" Rows="3" />
                                <span>
                                    <%=Resources.labels.separateTagsWitComma %></span>
                                <%=Resources.labels.or %>
                                <a href="javascript:void(ToggleTagSelector())">
                                    <%=Resources.labels.chooseFromExistingTags %></a>
                                <div id="tagselector" class="rounded" style="display: none;">
                                    <a class="close" onclick="ToggleTagSelector()"></a><span>
                                        <%=Resources.labels.clickTag %></span>
                                    <div class="clear">
                                    </div>
