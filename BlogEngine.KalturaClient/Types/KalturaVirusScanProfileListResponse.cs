...
namespace Kaltura
{
	public class KalturaVirusScanProfileListResponse : KalturaObjectBase
	{
		...
		#region Properties
		public IList<KalturaVirusScanProfile> Objects
		{
			get { return _Objects; }
			set 
			{ 
		...
		public KalturaVirusScanProfileListResponse(XmlElement node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "objects":
						this.Objects = new List<KalturaVirusScanProfile>();
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this.Objects.Add((KalturaVirusScanProfile)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
					case "totalCount":
		...
		public override KalturaParams ToParams()
		{
			...
			if (this.Objects != null)
			{
				...
				{
					int i = 0;
					foreach (KalturaVirusScanProfile item in this.Objects)
					{
